...
class SuccessInscriptionScreen extends GetWidget<SuccessInscriptionController> {
  @override
        ...
        child: Scaffold(
            ...
            body: Container(
                ...
                child: Container(
                    ...
                    padding: getPadding(left: 59, top: 71, right: 59),
                    child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                              ...
                              child: Text("msg_enr_gistrement_effectu".tr,
                                  overflow: TextOverflow.ellipsis,
                                  textAlign: TextAlign.left,
